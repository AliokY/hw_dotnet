...
namespace HW08.Task1
{
    ...
    {
        private const int SalaryCoeff = 8;
        private const int CurrentPremium = 500;
        ...
        public TeamLeader(string name, string surname, int experience, string[] responsibilities, string[] technologies, string gitHubLink) : 
