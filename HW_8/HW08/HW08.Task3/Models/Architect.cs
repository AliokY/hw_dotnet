...
namespace HW08.Task3
{
    class Architect : IEngineer
    {
        ...
        public Position CurrentPositioin { get; set; } = Position.Architect;
        static int BaseSalary { get; set; } = 500;
        public int SalaryCoeff { get; set; } = 12;
        public int CurrentPremium { get; set; } = 1000;
        ...
        public Architect(string name, string surname, int experience, string[] responsibilities, string[] technologies, 
