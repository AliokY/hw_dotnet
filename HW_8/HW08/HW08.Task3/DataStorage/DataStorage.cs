...
namespace HW08.Task3
{
    ...
    {
        internal static IEngineer[] mainStaff { get; private set; }
        ...
        internal static IEngineer[] InitializationStaff()
        {
            mainStaff = new IEngineer[13];
        ...
        internal static void SortStaffList(IEngineer[] mainStaff)
        {
            Array.Sort(mainStaff, new ExperienceComparer());
            Array.Reverse(mainStaff);
        }

        internal static string GetEngineerInfo(IEngineer engineer)
        {
            string engineerInfo = $"Company: {IEngineer.Company}," +
